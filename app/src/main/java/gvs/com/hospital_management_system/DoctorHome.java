...
public class DoctorHome extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.cpas) {
            fm.beginTransaction().replace(R.id.doctor_fragment_container,new ChangePassword()).commit();

        } else if (id == R.id.addtime) {
            fm.beginTransaction().replace(R.id.doctor_fragment_container,new AddTiming()).commit();

        } else if (id == R.id.mtime) {
            fm.beginTransaction().replace(R.id.doctor_fragment_container,new ViewAvailableTime()).commit();

        } else if (id == R.id.vapp) {
            fm.beginTransaction().replace(R.id.doctor_fragment_container,new ViewAppoinments()).commit();

        } else if (id == R.id.feedback) {
            fm.beginTransaction().replace(R.id.doctor_fragment_container,new ViewFeedbackDel()).commit();


        }else if (id == R.id.emergency) {
            fm.beginTransaction().replace(R.id.doctor_fragment_container,new ViewEmergencyNotifications()).commit();
